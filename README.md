...
- 現在のホストテスト構成: `test_temperature`, `test_temp_monitor`, `test_event_fsm`, `test_state_transition`
- 最新確認結果: 30 tests passed, 0 tests failed out of 30
...
3. Test Explorer で `test_temperature`, `test_temp_monitor`, `test_event_fsm`, `test_state_transition` を読み込んで実行する
